...
class ApplicationLocked extends React.PureComponent {
    constructor(props) {
        ...
        <Text style={this.props.styleTextButton
        ...
        this.renderTimer = (minutes, seconds) => {
            return (<View style={this.props.styleViewTimer
                ? this.props.styleViewTimer
                : styles.viewTimer}>
        <Text style={this.props.styleTextTimer
        ...
        this.renderTitle = () => {
            return (<Text style={this.props.styleTitle ? this.props.styleTitle : styles.title}>
        ...
        <Icon name={this.props.nameIcon ? this.props.nameIcon : 'lock'} size={this.props.sizeIcon ? this.props.sizeIcon : 24} color={this.props.colorIcon ? this.props.colorIcon : colors.white}/>
      </View>);
        };
        ...
        <Animate show={true} start={{
          ...
          {(state) => (<View style={{ opacity: state.opacity, flex: 1 }}>
              <View style={this.props.styleViewButton
    ...
    render() {
        return (<View style={this.props.styleMainContainer
