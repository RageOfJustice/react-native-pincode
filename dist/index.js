...
class PINCode extends React.PureComponent {
    ...
    componentWillMount() {
        return __awaiter(this, void 0, void 0, function* () {
            yield AsyncStorage.getItem(this.props.timePinLockedAsyncStorageName || timePinLockedAsyncStorageNameDefault).then((val) => {
